...
Monorepo for the codegen-coupled stack (`c5n`, `f8n`, `l10n`, `a11y`, `palette`, `doppel`, `etch`, `scribe`, `lattice`, `portfolio`, …). **Private during development.** Design docs live in each project dir (`c5n/DESIGN.md`, `f8n/DESIGN.md`, `l10n/DESIGN.md`, …).
