...
**Where it stands:** eight types hand-written in C# and TypeScript, six vector datasets
(182 cases) running in both languages from one dataset, and every one of them re-run under a
hostile locale, and the reference tables generated by
